...
public class MemberController {
	...
	public String withdrawalForm(@AuthenticationPrincipal SecurityUser principal, @PathVariable Long memberId,
			Model model, MemberDTO memberDTO, BindingResult bindingResult) {
	...
	public String withdrawal(MemberDTO memberDTO, @RequestParam String password, Authentication authentication,
	...
	public String update(@ModelAttribute MemberDTO memberDTO, Model model,
			@AuthenticationPrincipal SecurityUser principal, BindingResult bindingResult) {
		if (bindingResult.hasErrors()) {
			model.addAttribute("member", memberDTO);
			return "member/update";
		}
